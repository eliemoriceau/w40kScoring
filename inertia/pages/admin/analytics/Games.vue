          ...
          <div class="space-y-4">
            ...
            <div class="p-4 bg-slate-700 rounded-lg">
              ...
              <p class="text-slate-300 text-sm">
                ...
                ({{ getMostPopularGameTypePercentage() }}% du total).
              </p>
            </div>
...
const getOverallCompetitiveness = () => {
  ...
  const avgDifference = props.gameInsights.mostCompetitiveMatches
    .reduce((sum: number, match: any) => sum + match.scoreDifference, 0) / competitiveMatches
...
const getActivityInsight = () => {
  ...
  if (inProgress > completed) return `${inProgress} parties en cours montrent une activité soutenue.`
