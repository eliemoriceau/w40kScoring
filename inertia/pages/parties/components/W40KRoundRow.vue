<template>
  <div :class="roundStateClasses" class="animate-in fade-in duration-500">
    ...
    <div
      class="relative bg-gradient-to-r from-w40k-bg-secondary via-w40k-bg-elevated to-w40k-bg-secondary border-b-2 border-w40k-red-500/30 p-4 rounded-t-lg"
    >
      <!-- Effet de fond animé pour round actuel -->
      <div
        v-if="isCurrent"
        class="absolute inset-0 bg-gradient-to-r from-orange-900/30 via-w40k-red-900/20 to-orange-900/30 rounded-t-lg animate-pulse"
      />
      ...
      <div class="relative flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div class="flex items-center gap-3">
          ...
          <div
            class="w-10 h-10 bg-gradient-to-br from-w40k-red-600 to-w40k-red-800 rounded-full flex items-center justify-center shadow-lg"
          >
          ...
          <!-- Titre du round -->
          <h4
            class="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-w40k-red-300 to-w40k-gold-400"
          >
      ...
      <div
        v-if="isCurrent && !round.isCompleted"
        class="absolute -bottom-1 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-orange-500 to-transparent animate-pulse"
      />
    </div>

    <!-- Section des scores avec layout W40K -->
    <div
      class="relative bg-gradient-to-br from-w40k-bg-secondary to-w40k-bg-elevated border-2 border-w40k-red-500/50 rounded-b-lg p-6"
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
        ...
        <div class="flex justify-center items-center py-4">
          <div class="relative">
            ...
            <div
              class="bg-gradient-to-br from-w40k-bg-primary to-w40k-bg-secondary border-2 border-w40k-text-subtle rounded-full px-6 py-3 shadow-w40k-lg"
            >
            ...
            <div
              class="absolute -inset-1 bg-gradient-to-r from-w40k-red-500/20 via-w40k-gold-500/20 to-w40k-red-500/20 rounded-full blur animate-pulse opacity-75"
            />

            <!-- Épées croisées pour décoration -->
            <div class="absolute -top-2 -left-2 text-w40k-red-400 opacity-50">⚔️</div>
            <div class="absolute -bottom-2 -right-2 text-w40k-red-400 opacity-50 rotate-180">
              ⚔️
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-col items-center space-y-3">
          ...
          <div class="relative">
            ...
            <div
              v-else
              class="relative min-h-12 flex items-center justify-center border-2 border-dashed border-w40k-text-subtle/50 rounded-lg p-4 bg-w40k-bg-primary/50"
            >
    ...
    <div
      v-if="shouldShowCompletionHint"
      class="animate-in slide-in-from-bottom-2 duration-500 delay-300"
    >
      <div
        class="relative mt-4 bg-gradient-to-r from-green-900/30 via-green-800/20 to-green-900/30 border border-green-500/50 rounded-lg p-3"
      >
        <!-- Effet de fond pour la réussite -->
        <div
          class="absolute inset-0 bg-gradient-to-r from-green-500/10 to-transparent rounded-lg"
        />

        <div class="relative flex items-center justify-center gap-2 text-sm">
          <div
            class="w-5 h-5 bg-green-500 rounded-full flex items-center justify-center animate-pulse"
          >
    ...
    <div v-if="isEditing" class="absolute -top-2 -right-2 z-10">
      <div
        class="bg-w40k-red-600 text-white rounded-full px-3 py-1 text-xs font-bold shadow-lg animate-pulse"
      >
        ✏️ Édition en cours
      </div>
    </div>
...
const statusBadgeClasses = computed(() => {
  const baseClasses =
    'inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-bold border-2 transition-all duration-300 shadow-lg'
