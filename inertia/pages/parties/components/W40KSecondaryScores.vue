<template>
  <div class="animate-in slide-in-from-bottom-4 duration-700">
    ...
    >
      ...
      <div class="relative text-center space-y-3">
        <div class="flex items-center justify-center gap-3">
          <div
            class="w-8 h-8 bg-gradient-to-br from-w40k-gold-500 to-w40k-gold-700 rounded-full flex items-center justify-center shadow-lg"
          >
            <span class="text-lg font-black text-w40k-bg-primary">🎯</span>
          </div>
          <h3
            class="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-w40k-red-300 to-w40k-gold-400"
          >
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
      ...
      <div class="space-y-6">
        ...
        <div
          class="relative bg-gradient-to-r from-w40k-bg-secondary to-w40k-bg-elevated border border-w40k-red-500/50 rounded-lg p-4 text-center"
        >
          <div class="flex items-center justify-center gap-3">
            <div class="w-4 h-4 bg-w40k-red-500 rounded-full animate-pulse" />
            <h4 class="text-xl font-bold text-w40k-red-300">
          ...
          >
            ...
            <div class="flex items-center justify-between mb-3">
              <div class="flex items-center gap-2">
                <div
                  class="w-6 h-6 bg-gradient-to-br from-w40k-red-600 to-w40k-red-800 rounded-full flex items-center justify-center text-xs font-bold text-white"
                >
                  {{ round.roundNumber }}
                </div>
                <span class="text-sm font-bold text-w40k-text-secondary"
            ...
            <div class="space-y-2">
              ...
              >
                ...
                <div class="flex flex-col gap-1">
                  <span class="text-sm font-bold text-w40k-text-primary">{{
                    score.scoreName
                  }}</span>
                  <div class="flex items-center gap-2">
                    <span
                      class="text-lg font-black text-transparent bg-clip-text bg-gradient-to-r from-w40k-gold-400 to-w40k-gold-600"
                    >
                      {{ score.scoreValue }}
                    </span>
                ...
                <div
                  v-if="score.scoreValue >= 10"
                  class="absolute inset-0 bg-gradient-to-r from-transparent via-w40k-gold-500/10 to-transparent rounded-lg animate-pulse pointer-events-none"
                />
              </div>
              ...
              <div v-if="!hasSecondaryScores(round.id, players[0]?.id)" class="text-center py-6">
                <div class="space-y-2">
                  <div
                    class="w-12 h-12 mx-auto bg-gradient-to-br from-w40k-text-subtle/20 to-w40k-text-subtle/10 rounded-full flex items-center justify-center"
                  >
        ...
        <div
          class="relative bg-gradient-to-br from-w40k-bg-secondary to-w40k-bg-elevated border-2 border-w40k-gold-500/50 rounded-lg p-4 shadow-w40k-lg"
        >
          <!-- Effet de fond pour le total -->
          <div
            class="absolute inset-0 bg-gradient-to-r from-w40k-gold-900/20 via-transparent to-w40k-gold-900/20 rounded-lg"
          />

          <div class="relative flex items-center justify-between">
            <div class="flex items-center gap-2">
              <div
                class="w-6 h-6 bg-w40k-gold-500 rounded-full flex items-center justify-center animate-pulse"
              >
                <span class="text-xs font-bold text-w40k-bg-primary">🏆</span>
              </div>
              <span class="text-sm font-bold text-w40k-text-secondary"
                >Total Objectifs Secondaires</span
              >
            </div>
            <div class="flex items-center gap-2">
              <span
                class="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-w40k-gold-400 to-w40k-gold-600"
              >
      ...
      <div v-if="players[1]" class="space-y-6">
        <!-- En-tête joueur 2 -->
        <div
          class="relative bg-gradient-to-l from-w40k-bg-secondary to-w40k-bg-elevated border border-w40k-red-500/50 rounded-lg p-4 text-center"
        >
          <div class="flex items-center justify-center gap-3">
            <div class="w-4 h-4 bg-w40k-red-500 rounded-full animate-pulse" />
            ...
            <div class="space-y-2">
              ...
              >
                <div class="flex flex-col gap-1">
                  ...
                  <div class="flex items-center gap-2">
                    <span
                      class="text-lg font-black text-transparent bg-clip-text bg-gradient-to-l from-w40k-gold-400 to-w40k-gold-600"
                    >
                      {{ score.scoreValue }}
                    </span>
                    <span class="text-xs text-w40k-text-secondary font-medium">points</span>
                ...
                <div
                  v-if="score.scoreValue >= 10"
                  class="absolute inset-0 bg-gradient-to-l from-transparent via-w40k-gold-500/10 to-transparent rounded-lg animate-pulse pointer-events-none"
                />
              </div>
              ...
              <div v-if="!hasSecondaryScores(round.id, players[1].id)" class="text-center py-6">
                <div class="space-y-2">
                  <div
                    class="w-12 h-12 mx-auto bg-gradient-to-bl from-w40k-text-subtle/20 to-w40k-text-subtle/10 rounded-full flex items-center justify-center"
                  >
                    <span class="text-2xl opacity-50">⚡</span>
                  </div>
                  <p class="text-sm text-w40k-text-muted">Aucun objectif secondaire</p>
        ...
        <!-- Total joueur 2 -->
        <div
          class="relative bg-gradient-to-bl from-w40k-bg-secondary to-w40k-bg-elevated border-2 border-w40k-gold-500/50 rounded-lg p-4 shadow-w40k-lg"
        >
          <div
            class="absolute inset-0 bg-gradient-to-l from-w40k-gold-900/20 via-transparent to-w40k-gold-900/20 rounded-lg"
          />
          ...
          <div class="relative flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              <span
                class="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-l from-w40k-gold-400 to-w40k-gold-600"
              >
      ...
      <div v-else class="space-y-6 opacity-60">
        <div
          class="bg-gradient-to-l from-w40k-bg-secondary to-w40k-bg-elevated border border-w40k-text-subtle/30 rounded-lg p-4 text-center"
        >
          <div class="flex items-center justify-center gap-3">
        ...
        <div
          class="bg-gradient-to-bl from-w40k-bg-secondary/50 to-w40k-bg-elevated/50 border border-dashed border-w40k-text-subtle/30 rounded-lg p-8"
        >
          <div class="text-center space-y-4">
            <div
              class="w-16 h-16 mx-auto bg-gradient-to-br from-w40k-text-subtle/20 to-w40k-text-subtle/10 rounded-full flex items-center justify-center"
            >
              <span class="text-3xl opacity-50">🛡️</span>
            </div>
            <p class="text-w40k-text-muted">
              Les objectifs secondaires apparaîtront ici une fois l'adversaire rejoint
            </p>
          </div>
        </div>
      </div>
  ...
  >
    ...
    >
      <div
        class="relative bg-gradient-to-br from-w40k-bg-secondary to-w40k-bg-elevated border-2 border-w40k-red-500/50 rounded-xl p-6 w-full max-w-md shadow-2xl"
        @click.stop
      >
        <!-- Effet de fond animé pour la modal -->
        <div
          class="absolute inset-0 bg-gradient-to-r from-w40k-red-900/10 via-transparent to-w40k-gold-900/10 rounded-xl"
        />
        ...
        <div class="relative space-y-6">
          ...
          <div class="text-center">
            <div
              class="w-12 h-12 mx-auto bg-gradient-to-br from-w40k-red-600 to-w40k-red-800 rounded-full flex items-center justify-center mb-3 shadow-lg"
            >
              <span class="text-xl font-black text-white">{{ editingScore ? '✏️' : '➕' }}</span>
            </div>
            <h3
              class="text-xl font-black text-transparent bg-clip-text bg-gradient-to-r from-w40k-red-300 to-w40k-gold-400"
            >
...
const saveSecondaryScore = async () => {
  ...
  try {
    const endpoint = editingScore.value ? `/scores/${editingScore.value.id}` : '/scores'
    ...
    await router[method](
      ...
      },
      {
        ...
        onError: (errors) => {
          console.error('Erreur lors de la sauvegarde du score secondaire:', errors)
          // Afficher l'erreur dans une notification si possible
          if (typeof errors === 'string') {
            alert(`Erreur: ${errors}`)
          } else {
            alert('Erreur lors de la sauvegarde du score secondaire')
          }
        },
      }
    )
...
const deleteSecondaryScore = async (scoreId: number) => {
  if (
    !confirm(
      '⚠️ Êtes-vous sûr de vouloir supprimer cet objectif secondaire ? Cette action est irréversible !'
    )
  ) {
    return
  }
