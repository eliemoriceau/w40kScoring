...
router
  .group(() => {
    ...
    router.get('/analytics/platform', [AdminAnalyticsController, 'platform']).as('analytics.platform')
    ...
    router.get('/analytics/api/platform-metrics', [AdminAnalyticsController, 'platformMetrics']).as('analytics.api.platform_metrics')
    router.get('/analytics/api/game-insights', [AdminAnalyticsController, 'gameInsights']).as('analytics.api.game_insights')
    router.get('/analytics/api/period-comparison', [AdminAnalyticsController, 'periodComparison']).as('analytics.api.period_comparison')
    router.get('/analytics/api/player-stats/:userId', [AdminAnalyticsController, 'playerStats']).as('analytics.api.player_stats')
